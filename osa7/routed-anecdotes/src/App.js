...
const AnecdoteInfo = ({anecdotes}) => {
    ...
    return (
        <div>
            ...
            <h3>anecdote written by. {anecdote.author}</h3>
...
const CreateNew = (props) => {
    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit} onReset={clearInput}>
                <div>
                    content
                    <input type='content' value={content.value} onChange={content.onChange}/>
                </div>
                <div>
                    author
                    <input type='author' value={author.value} onChange={author.onChange}/>
                </div>
                <div>
                    url for more info
                    <input type='info' value={info.value} onChange={info.onChange}/>
                </div>
...
const App = () => {
    ...
    return (
        <div>
            ...
            <Router>
                <Routes>
                    <Route path="/anecdotes/:id" element={<AnecdoteInfo anecdotes={anecdotes}/>}/>
